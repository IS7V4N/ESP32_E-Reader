...
void EpubReaderActivity::renderContents(std::unique_ptr<Page> page, const int orientedMarginTop,
  ...
  if (SETTINGS.textAntiAliasing) {
    ...
    // Force HALF_REFRESH on the next page: grayscale particles remain at intermediate
    // levels and FAST_REFRESH's differential update cannot fully correct them.
    // HALF_REFRESH bypasses RED RAM comparison and drives every pixel to pure B/W.
